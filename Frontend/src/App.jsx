      ...
      <div className="max-w-6xl w-full px-4 py-4">
        <div className="rounded-[2.5rem] p-8 bg-gradient-to-br from-[#0f2027] via-[#2c5364] to-[#232526] shadow-2xl">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Contests Card */}
            <div className="bg-[#18181b] border border-cyan-500/30 rounded-2xl p-8 shadow-xl hover:scale-105 hover:border-cyan-400 transition-transform cursor-pointer flex flex-col items-center">
